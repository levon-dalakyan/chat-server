...
test:
	go clean -testcache
	go test ./... -covermode count -coverpkg=github.com/ldevprog/chat-server/internal/service/...,github.com/ldevprog/chat-server/internal/api/... -count 5

test-coverage:
	go clean -testcache
	go test ./... -coverprofile=coverage.tmp.out -covermode count -coverpkg=github.com/ldevprog/chat-server/internal/service/...,github.com/ldevprog/chat-server/internal/api/... -count 5 
